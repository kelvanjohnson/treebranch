...
import 'package:treebranch/providers/token_provider.dart';
...
Future<void> main() async {
  ...
  SharedPreferencesWithCache prefs = await SharedPreferencesWithCache.create(
    cacheOptions: const SharedPreferencesWithCacheOptions(
      allowList: <String>{"access_token","refresh_token"},
    ),
  );
  runApp(ProviderScope(
    overrides: [
      sharedPreferences.overrideWithValue(prefs),
    ],
    child: Treebranch(),
  ));
}
...
class _HomeContainerState extends ConsumerState<HomeContainer> {
  ...
  Widget build (BuildContext context) {
    Widget page;
    final String accessToken = ref.watch(TokenNotifierProvider("access_token"));
    final String refreshToken = ref.watch(TokenNotifierProvider("refresh_token"));
